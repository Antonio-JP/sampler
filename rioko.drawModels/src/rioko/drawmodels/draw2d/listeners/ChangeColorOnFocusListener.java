...
public class ChangeColorOnFocusListener implements MouseListener {
	...
	//Builders	
	/**
	 * Generic builder to create the wizardListener. It recieves the colors between swap and the figure that will change.
	 * 
	 ...
	 * @param figure Figure that will be related with this wizardListener
	 */
