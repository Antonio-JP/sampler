...
public class EClassConfiguration implements ModelDepending, ComboConfiguration {
	...
	public EClassConfiguration(ModelDiagram model) throws BadConfigurationException {
		if(model == null) {
	...
	public EClassConfiguration(ModelDiagram model, EClass value) throws BadConfigurationException {
		this(model);
