...
public class TreeDirectedSearchIterator<V extends DiagramNode> extends DirectedSearchIterator<V> {

	public TreeDirectedSearchIterator(AdjacencyListGraph<V,? extends Edge<V>> graph, V root) {
		super(graph, root);
	}
	
	public TreeDirectedSearchIterator(AdjacencyListGraph<V,? extends Edge<V>> graph, V root, boolean searchAll) {
