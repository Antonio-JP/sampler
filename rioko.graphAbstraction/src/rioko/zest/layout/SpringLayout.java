...
public class SpringLayout extends AbstractLayoutAlgorithm {

	private SpringLayoutAlgorithm algorithm;
	
	public SpringLayout() {
		this.algorithm = new SpringLayoutAlgorithm(LayoutStyles.NO_LAYOUT_NODE_RESIZING);
	}
	
	public SpringLayout(int style) {
		this.algorithm = new SpringLayoutAlgorithm(style);
	}
