...
public class CreateDiagramPerformance {
	...
	//Builders
	public CreateDiagramPerformance(Integer size) {
	...
	public void tearDown() throws Exception {
		...
		//Cleaning the memory
		GeneralReader.closeFile(this.project);
	...
	public void test() throws Exception{
		...
		Timing currentTime = Timing.getInstance("FolderPerformance.csv");
					
		System.out.println("("+ this.currentSize + "): +++ Begginnig algorithm");
		
		FolderReader reader = new FolderReader(this.project);
